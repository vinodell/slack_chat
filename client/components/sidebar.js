...
const Sidebar = () => {
  return (
    <div className="bg-gray-800 text-gray-500 w-1/5 pb-6 hidden md:block">
      <h1 className="text-white text-xl mb-2 mt-3 px-4 font-sans flex justify-between font-boldf">
      ...
      <div className="px-4 mb-2 font-sans font-bold">Channels</div>
      ...
      <div className="flex items-center mb-3 px-4">
        <span className="bg-yellow-400 rounded-full block w-2 h-2 mr-2" />
      ...
      <div className="px-4 mb-3 font-sans font-bold">Applications</div>
    </div>
  )
}
